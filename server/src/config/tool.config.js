...
export const availableTools = [
    {
        id:"google_search",
        name:"Google Search",
        description:"Access the latest information using google serach.useful for current events ,and rea-time information",
...
export function getEnabledTools() {
    ...
    try{
        ...
        console.error(chalk.red('[ERROR] failed to intialize tools:'),error.message);
        console.log(chalk.yellow('make sure you have @ai-sdk/google 2.0+ installed'));
        console.log(chalk.yellow('Run:npm intstall @ai-sdk/google@latest'));
        return undefined;
    }
}
